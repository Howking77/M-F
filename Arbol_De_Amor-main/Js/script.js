...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "For my love, from your love";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2022-11-22T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-11-22T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Desde hace: <b>${days}</b> días<br>` +
      `Un año mas en: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
